...
<xsl:template match="example-with-output/image[@*]">
  <tr align="center"><td>
      <xsl:element name="a">
	<xsl:attribute name="href"><xsl:value-of select="/book/examples-home/@href" /><xsl:value-of select="@pdf" /></xsl:attribute>
	<xsl:element name="img">
	  <xsl:attribute name="src"><xsl:value-of select="/book/examples-home/@href" /><xsl:value-of select="@jpg" /></xsl:attribute>
...
<xsl:template match="example-with-output/source[@file]">
  ...
  <tr align="center"><td>Source: 
      ...
      — 
      <xsl:element name="a">
				<xsl:attribute name="href"><xsl:value-of select="/book/examples-home/@href" /><xsl:value-of select="@file" /></xsl:attribute>
				visit
      </xsl:element>
  </td></tr>
  <xsl:element name="tr">
